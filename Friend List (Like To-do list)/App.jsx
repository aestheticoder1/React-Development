...
// TO DO APP BY FORM HANDLING 
function App() {

  const [data,setData] = useState([]);

  const handleClickData = (inputdata,reset)=>{
    setData((prev)=>{
      reset();
  ...
  return(
      // TO DO LIST TYPE PROJECT 
      
      <div className='h-screen w-full bg-zinc-200 p-8 flex justify-center items-center flex-col overflow-hidden gap-20'>

        {/* Heading  */}
        <h1 className='font-bold text-6xl bg-blue-500 px-8 py-3 rounded-md text-white '>People Data</h1>

        {/* CARDS COMPONENT  */}
        <Cards removeItem={removeItem} data={data}/>

        {/* FORM COMPONENT  */}
        <Form handleClickData={handleClickData}/>
...
//   return(
//     <div>
//       <form action="" onClick={handleSubmit(data=>console.log(data))}>
//         <input {...register('your_name')} type="text" placeholder='name' />
//         <input {...register('your_email')} type="email" placeholder='email'/>
//         <input type="submit" />
//       </form>
//     </div>
//   )
